/* ACT I — SLOP PSYCHOSIS. Quotes deep-link into episodes at the second they were
   said (moments, from the verified ledger). Flows into deck-trust. */
window.DECK = {
  "name": "slop psychosis",
  "sections": [
    {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "list": [
        [
          "01 PARASOCIAL",
          "it thinks you're brilliant",
          "cyan"
        ],
        [
          "02 HEADROOM",
          "the meter runs while you grill",
          "magenta"
        ],
        [
          "03 HARDWARE",
          "a DGX spark will fix me",
          "lime"
        ],
        [
          "04 ACCOMPLISHMENT",
    ...
    {
      "id": "p1",
      "kicker": "psychosis 01 · parasocial",
    ...
    {
      "id": "p4",
      "kicker": "psychosis 04 · accomplishment",
      ...
      "moments": [
        ...
        },
        {
          ...
          "t": 2383,
          "who": "jmann",
          "quote": "You put a quarter into the thing and you turn the little knob, and it gives you like a little bobble. And you're like, yay, I got a bobble! And then like you throw it in the trash"
        }
      ],
    ...
    {
      "id": "p5",
      "kicker": "psychosis 05 · overtuning",
      ...
      "moments": [
        ...
        },
        {
          ...
          "t": 3426,
          "who": "austin",
          "quote": "Focusing the back of your mind on how can I make the prompt better — you're one prompt away from fixing an important thing."
        },
        {
          "ep": "sodofi",
          "t": 1559,
          "who": "austin",
          "quote": "There's the FOMO of being the best possible AI builder. I use loops now and then, but I prompt a lot still, and it's fine. I build shit quickly."
        },
        {
          "ep": "omniharmonic",
          "t": 2510,
          "who": "omniharmonic",
          "quote": "It did that four or five times until it got to 85% or above approval rating. I don't know if I'm just wasting burning tokens."
        }
      ],
    ...
    {
      "id": "p6",
      "kicker": "psychosis 06 · over-reliance",
    ...
    },
    {
      "id": "closer",
      "kicker": "act I → act II",
      "title": "so if code is <span class=\"hl2\">free</span>…<br>what's still <span class=\"hl\">scarce</span>?",
      "sub": "that's act II →",
      "points": [
        "the psychoses are what free code does to your brain.",
        "next: what it does to the market."
      ]
    }
  ]
};
